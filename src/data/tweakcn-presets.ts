...
import { builtInPresetIds, type BuiltInPresetId } from "./built-in-preset-ids";

/**
 * TweakCN's ThemePreset interface structure (exact match with TweakCN)
 */
export interface TweakCNThemePreset {
...
export { builtInPresetIds, type BuiltInPresetId };
 ...
 */
export const tweakcnPresets: Record<string, TweakCNThemePreset> = {
  "modern-minimal": {
 ...
 * Get all preset IDs
 */
export function getPresetIds(): BuiltInPresetId[] {
 ...
 * Get preset by ID
 */
export function getPresetById(id: BuiltInPresetId): TweakCNThemePreset;
export function getPresetById(id: string): TweakCNThemePreset | null;
export function getPresetById(id: string): TweakCNThemePreset | null {
 ...
 */
export function getPresetLabels(): string[] {
 ...
 */
export function searchPresets(query: string): Array<{ id: BuiltInPresetId; preset: TweakCNThemePreset }> {
  const lowerQuery = query.toLowerCase();
  return builtInPresetIds
    .map((id) => ({ id, preset: tweakcnPresets[id] }))
    .filter(
 ...
 * Get presets count
 */
export function getPresetsCount(): number {
 ...
 */
export function getPresetEntries(): Array<[BuiltInPresetId, TweakCNThemePreset]> {
  return builtInPresetIds.map((id) => [id, tweakcnPresets[id]] as [BuiltInPresetId, TweakCNThemePreset]);
}
